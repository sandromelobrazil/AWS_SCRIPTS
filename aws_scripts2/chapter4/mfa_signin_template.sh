...
adminrolearn=SEDadminrolearnSED
connectrolearn=SEDconnectrolearnSED
...
# username and virtual mfa device serial
username=SEDusernameSED
mfaserial=SEDmfaserialSED
...
if test "$cred" = ""; then
	# it didn't work
	echo ensure you are signed in as the assumer user
